...
* Download and install mysql /n
* Download the repository /n
* In the "app.js" file, edit the value for your passowrd inside the  "mysql.createConnection" object equaling the passowrd for your mysql connection /n
* Run "schema.sql" in your UI of choice so that the "our_workplace" database is created along with all the tables /n
* In your node terminal, execute code "npm i" to install the dependcies for this package /n
* If errors do not occur, execute code "npm start" /n
* From here, prompts in the terminal should guide you through all the functionality of the node app /n
...
## Usage
Prompts allow you to navigate through the app effortlessly using node. Someone tasked to input employees' data can easily add and edit a database that is created. Searching for particular tables on this database is just as simple as searching for combined information!
